 ...
 * the only caller left is `FlowAbsence` below. Deleted from the barrel rather than from the
 * file, because an export with no importer is an invitation to spell the absence a second
 * way somewhere else. `VIZ.dash.absent` keeps its export: `FlowAbsence` strokes with it and
 * three figures in `components/home` name it.
 */
const ABSENT_GLYPH = "◌";
