/* ============================================================
   ...
   ── The ladder runs 1 to 5, and it has one source ──
   It used to run 1 to 4 on the strength of a BlueGrid post that
   sat behind a Cloudflare challenge and could not be read. The
   HackerNoon piece, which can be, sets out five: autocomplete,
   chat-assisted, agentic, harness-driven, and the dark factory at
   the top. The citation and the claim now match, and the BlueGrid
   card is gone rather than left standing behind a count it does not
   support.
 ...
 *
 * The framing is the one the HackerNoon piece works through and the names are its own;
 * the sentences are ours, because a landing that paraphrases a source badly is worse
 * than one that says plainly which source it is borrowing from. It is linked underneath.
 *
...
/** The references doc 2 §1 asks the landing to carry. Every URL is a real one. */
const SOURCES: Source[] = [
  {
    ...
    note: "Where the five levels come from, and one team's account of the climb.",
  },
  {
          ...
          <dl className="mt-6 grid gap-5 md:grid-cols-2">
            <div className="flex flex-col gap-2 border-l-2 border-line-bright pl-4">
              ...
              <dd className="text-sm leading-relaxed text-muted">
                ...
                team is able to do at all, across everything it ships. This is the one
                thing on the site that is counted in rungs.
              </dd>
            </div>
