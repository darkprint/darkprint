...
| node | card |
| --- | --- |
| `raw` | `document-intake@1.0.0` |
| `extract` | `field-extractor@1.0.0` |
| `normalize` | `field-normalizer@1.1.0` |
| `validate` | `schema-gate@1.1.0` |
| `repair` | `record-repairer@1.1.0` |
| `store` | `record-store@1.0.0` |
| `publish` | `dataset-publisher@1.0.0` |

---

Exported from https://www.darkprint.io/blueprints/schema-forge-etl
