...
bundle digest  sha256:7cff1f063d74837eae3f5c3bbae9a0988cfd7d7730f13792eeedb0238cd71e68
nodes          8
cards pinned   8
```
...
| `plan` | `task-decomposer@1.0.0` |
| `solverA` | `conservative-solver@1.0.0` |
| `solverB` | `exploratory-solver@1.0.0` |
| `vote` | `weighted-vote@1.0.0` |
| `verify` | `acceptance-verifier@2.0.0` |
| `reopen` | `bounded-retry@1.0.0` |
| `deliver` | `result-delivery@1.0.0` |
