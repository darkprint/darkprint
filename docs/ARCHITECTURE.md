...
| `content/` | 16 blueprints under `blueprints/<slug>/` (`blueprint.yaml`, `topology.dot`), 111 card versions under `cards/` of which 8 are pinned by no blueprint, `ontology/extensions.yaml` |
