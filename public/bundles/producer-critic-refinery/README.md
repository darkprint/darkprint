...
A drafting line split in two: the node that writes the work never sees the rubric the work is graded against, and the node that holds the rubric never writes a word of it.

```
blueprint      producer-critic-refinery
bundle digest  sha256:35ece9255c6d3bbac16ee97545613f578ffd3cfb8288598d7182b9563c9a72ae
nodes          5
cards pinned   5
```
...
| node | card |
| --- | --- |
| `rubric` | `rubric-author@1.0.0` |
| `produce` | `draft-producer@1.0.0` |
| `critique` | `draft-critic@1.0.0` |
| `revise` | `draft-reviser@1.0.0` |
| `deliver` | `draft-delivery@1.0.0` |

---

Exported from https://www.darkprint.io/blueprints/producer-critic-refinery
