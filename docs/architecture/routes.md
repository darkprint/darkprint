...
| `/api/mcp/blueprints/[owner]/[slug]/releases/[digest]` | `app/api/mcp/blueprints/[owner]/[slug]/releases/[digest]/route.ts` | GET | public-only, rate-limited `read` | The release FILE LIST (names, not bytes — the bytes have a route, and serving them twice differs in download accounting, D-220-16) | SEAM-91 |
