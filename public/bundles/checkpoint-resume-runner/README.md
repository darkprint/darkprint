...
bundle digest  sha256:775d7bd6315b35e6ce3160cc25a25bed6be952f4f1b2f6bcbedaacf9409a4c63
ontology       v0.1.0
nodes          9
cards pinned   9
```
...
> 9 of 9 nodes run unattended, none have a person in the loop — 1.00 > 0.90 → level 4 (Closed-loop).
