        ...
        <section className="grid gap-6 lg:grid-cols-[minmax(0,1fr)_minmax(0,1fr)] lg:items-start">
          <div className="flex flex-col gap-4 text-[15px] leading-relaxed text-muted">
            ...
            <p>
              ...
              format splits in two: the graph carries the wiring and every piece
              of detail lives in a card beside it. One attribute does the
              joining. A node writes <Id>card=&quot;id@version&quot;</Id>, and
              the version is exact, so the same file read twice describes the
              same five nodes.
            </p>
            <p>
              ...
              runs as it stands. Attractor reserves a list of attribute names and
              silently ignores every name outside it, which is what lets{" "}
              <Id>card</Id> and <Id>digest</Id> ride along in a file a runner
              still executes. The compatibility linter reports the places a file
              would stop being runnable as warnings in their own{" "}
              <Id>attractor/</Id> namespace, so a reader can tell which of the
              two readers is complaining.
            </p>
            <p>
              One name is worth knowing about because it looks free and is not. A
              node <Id>type</Id> attribute means{" "}
