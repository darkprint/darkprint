...
export function agentBrief(): string {
  return [
    ...
    "     cannot            data types that must never reach it  <- decide this first",
    "     will_not          the rules you state and no engine can check",
    "",
    "4. Write the graph in DOT. One edge per handoff, and every node carrying",
    '   card="<id>@<version>".',
    "",
    "5. Leave out every edge that would carry a data type a node listed under cannot.",
    "   An edge you do not draw is as much a part of the design as one you do. This",
    "   is the step to get right.",
    "",
