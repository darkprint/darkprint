 ...
 *
 * `searchParams` is still not read here, and the reason is now stronger than it was. It
 * used to be that touching it would opt a static route into on-demand rendering; the route
 * renders per request either way now, but a server component that reads `searchParams`
