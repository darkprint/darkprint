...
Find an outside agent that can do the work, hand it over, and check what comes back as if it came from nowhere, because as far as this graph can tell it did.

```
blueprint      delegation-broker
bundle digest  sha256:5bbd8b83e1ed1c09b374b2c5cfc9f486cbde7783f841dd29ff4185069a68d84f
nodes          7
cards pinned   7
local terms    autogen/unverified-delegation
```
...
| `discover` | `agent-card-resolver@1.0.0` |
| `match` | `capability-matcher@1.0.0` |
| `delegate` | `a2a-delegate@1.0.0` |
| `local` | `local-solver@1.0.0` |
| `verify` | `remote-result-check@1.0.0` |
| `deliver` | `broker-delivery@1.0.0` |

---

Exported from https://www.darkprint.io/blueprints/delegation-broker
